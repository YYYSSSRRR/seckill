...
func (x *Etcd) GetDiscovery() *Discovery {
	if x != nil {
		return x.Discovery
	}
	return nil
...
func (x *Discovery) GetProduct() string {
	if x != nil {
		return x.Product
	}
	return ""
...
func (x *Discovery) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\bRegistry\x12$\n" +
	"\x04etcd\x18\x01 \x01(\v2\x10.kratos.api.EtcdR\x04etcd\"\x8d\x01\n" +
	"\x04Etcd\x12\x1c\n" +
	"\tendpoints\x18\x01 \x03(\tR\tendpoints\x12\x18\n" +
	"\atimeout\x18\x02 \x01(\tR\atimeout\x123\n" +
	"\tdiscovery\x18\x03 \x01(\v2\x15.kratos.api.DiscoveryR\tdiscovery\x12\x18\n" +
	"\aservice\x18\x04 \x01(\tR\aservice\"9\n" +
	"\tDiscovery\x12\x18\n" +
	"\aproduct\x18\x01 \x01(\tR\aproduct\x12\x12\n" +
	"\x04user\x18\x02 \x01(\tR\x04userB\x1cZ\x1agateway/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	4,  // 7: kratos.api.Registry.etcd:type_name -> kratos.api.Etcd
	5,  // 8: kratos.api.Etcd.discovery:type_name -> kratos.api.Discovery
