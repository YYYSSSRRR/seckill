...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x02db\x18\x06 \x01(\x05R\x02db\"0\n" +
	"\bRegistry\x12$\n" +
	"\x04etcd\x18\x01 \x01(\v2\x10.kratos.api.EtcdR\x04etcd\"s\n" +
	"\x04Etcd\x12\x1c\n" +
	"\tendpoints\x18\x01 \x03(\tR\tendpoints\x12\x18\n" +
	"\atimeout\x18\x02 \x01(\tR\atimeout\x123\n" +
	"\tdiscovery\x18\x03 \x01(\v2\x15.kratos.api.DiscoveryR\tdiscovery\"9\n" +
	"\tDiscovery\x12\x18\n" +
	"\aproduct\x18\x01 \x01(\tR\aproduct\x12\x12\n" +
	"\x04user\x18\x02 \x01(\tR\x04userB$Z\"seckill_service/internal/conf;confb\x06proto3"
